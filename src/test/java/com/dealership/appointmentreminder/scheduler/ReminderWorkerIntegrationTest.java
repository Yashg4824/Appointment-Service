 ...
 */
class ReminderWorkerIntegrationTest extends AbstractIntegrationTest {
    ...
    void shouldMarkReminderSentAfterSuccessfulNotification() {
        ...
        worker.process(claimSingleReminder());
    ...
    void shouldContainSenderFailureRatherThanPropagatingIt() {
        ...
        org.assertj.core.api.Assertions
                .assertThatCode(() -> worker.process(claimSingleReminder()))
