 ...
 * reviewer or operator may want to change without recompiling: how large a batch to claim, how
 * long a claim survives, how long to wait before retrying, when to give up, and how late a
 * reminder may be and still be worth sending. Collecting them in one typed
